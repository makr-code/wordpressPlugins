...
<main id="primary" class="content-area">
    ...
    if ( have_posts() ) :
        ...
        if ( ! is_paged() ) :
            ...
            $has_sticky_posts = ! empty( $sticky_posts );
            ...
            if ( $featured_query->have_posts() ) :
                ...
                <section class="featured-slider-section">
                    <h2 class="section-title">
                        <?php echo esc_html( $has_sticky_posts ? __( 'Featured Articles', 'themisdb' ) : __( 'Latest Articles', 'themisdb' ) ); ?>
                    </h2>
        ...
        if ( ! is_front_page() ) :
            $home_title = single_post_title( '', false );
            if ( '' === $home_title ) {
                $home_title = __( 'Blog', 'themisdb' );
            }
            ?>
            <header class="page-header">
                <h1 class="page-title"><?php echo esc_html( $home_title ); ?></h1>
            </header>
            <?php
        endif;
        ?>
