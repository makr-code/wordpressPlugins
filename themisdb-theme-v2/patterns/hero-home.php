...
<div class="wp-block-cover themis-hero-section is-dark" style="min-height:620px">
	...
	<div class="wp-block-cover__inner-container">
		...
		<h1 class="has-text-color wp-block-heading has-text-align-center" style="color:#ffffff;font-size:clamp(2.25rem,5vw,3.75rem);font-weight:800;line-height:1.12;letter-spacing:-0.04em;">The Database Built for<br>the AI Era</h1>
		<!-- /wp:heading -->
